...
export default function Wishlist() {
  ...
  const { wishlist, fetchWishlistProducts, addProductToCart } = useProducts();
  ...
  return (
    <div className={` ${ isDark ? "bg-[#121212]" : "bg-[#FAF9F6]"} w-full min-h-screen transition-colors duration-500`}>
        ...
        <div className={`max-w-7xl mx-auto pb-32 transition-colors duration-500 pt-10 px-5 }`}>
                    ...
                    {wishlist?.products.map((item, index) => (
                        ...
                        <div className={`aspect-4/5 mb-6 overflow-hidden relative border transition-colors rounded-xl ${
                            ...
                            <button 
                                ...
                                className={`grow py-4 cursor-pointer rounded-xl hover:border text-[10px] font-bold uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 ${
                            ...
                            <button 
                                ...
                                className={`aspect-square cursor-pointer rounded-xl p-4 border hover:border-red-500 hover:text-red-500 transition-all ${
                        ...
                        <div className="flex justify-between items-start">
                            <Link href={`/product/${item._id}`} className="cursor-pointer">
